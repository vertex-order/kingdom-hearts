window.__khSeriesReg['KH'] = { num: 'KH', releaseDate: '2002-03-28', chronoOrder: 1075, recommendedOrder: 1795, title: 'Kingdom Hearts', note: 'A franchise in its own right, with original characters and story. A crossover that primarily focuses on Disney characters, though some entries also feature Final Fantasy characters.', games: [
        { title: 'Kingdom Hearts (2002) Remaster (2013)', mainline: true, releaseDate: '2002-03-28', chronoOrder: 0, recommendedOrder: 100, mediaType: 'Game', tags: ['Action RPG', 'Hack and slash', 'Single-player'], lengthParts: [{ value: '28½h', tip: 'Main Story', sep: true, sepChar: ' / ' }, { value: '41h', tip: 'Main + Sides', sep: true, sepChar: ' / ' }, { value: '62½h', tip: 'Completionist' }],
        rating: { scoreLabelText: 'Metacritic', midLabelText: 'Metacritic User Score', score: '85', midScore: '8.5', midUrl: 'https://www.metacritic.com/game/kingdom-hearts/', url: 'https://www.metacritic.com/game/kingdom-hearts/', single: true },
        parts: [
          { label: 'Kingdom Hearts (2002)', url: 'https://en.wikipedia.org/wiki/Kingdom_Hearts_(video_game)' },
          { label: 'Remaster (2013)', url: 'https://en.wikipedia.org/wiki/Kingdom_Hearts_(video_game)#HD_1.5_Remix', small: true },
        ],
        languages: [
        ...
        platformGroups: [
          ...
          [
            { key: 'fan-movie', paren: 'Youtube', url: 'https://www.youtube.com/results?search_query=Kingdom%20Hearts%20game%20movie' },
            { key: 'fan-recap', paren: 'Youtube', url: 'https://www.youtube.com/results?search_query=Kingdom%20Hearts%20story%20recap' },
            { key: 'fan-playthrough', paren: 'Youtube', url: 'https://www.youtube.com/results?search_query=Kingdom%20Hearts%20playthrough' },
          ],
        ],
        description: [
        ...
        { title: 'Kingdom Hearts ~Manga~ (2003)', releaseDate: '2003-10-25', chronoOrder: 25, recommendedOrder: 125, tags: ['Optional', 'Manga'], mediaType: 'Comic', lengthParts: [{ value: '4 volumes' }],
        parts: [
        ...
        languages: [
          { value: 'JA', tip: 'Japanese', native: true, url: 'https://www.goodreads.com/book/show/11874890-1-kingdom-hearts-1' },
          { value: 'EN', tip: 'English (US)', url: 'https://www.goodreads.com/book/show/231914.Kingdom_Hearts_Vol_1' },
          { value: 'DE', tip: 'German', url: 'https://www.goodreads.com/book/show/2946519-kingdom-hearts-band-1' },
          { value: 'FR', tip: 'French', url: 'https://www.goodreads.com/book/show/15848235-kingdom-hearts-vol-1' },
          { value: 'IT', tip: 'Italian', url: 'https://www.goodreads.com/book/show/23574414-kingdom-hearts-vol-1' },
          { value: 'ES', tip: 'Spanish (Castilian)', url: 'https://www.goodreads.com/book/show/45434630-kingdom-hearts-vol-1' },
          { value: 'EL', tip: 'Greek', url: 'https://www.goodreads.com/book/show/35435731-kingdom-hearts-1' },
        ...
        languages: [
          { value: 'JA', tip: 'Japanese', native: true, url: 'https://www.goodreads.com/book/show/21419607' },
          { value: 'EN', tip: 'English', url: 'https://www.goodreads.com/book/show/23197294-kingdom-hearts' },
        ...
        platformGroups: [
          ...
          [
            { key: 'fan-movie', paren: 'Youtube', url: 'https://www.youtube.com/results?search_query=Kingdom%20Hearts%20Chain%20of%20Memories%20game%20movie' },
            { key: 'fan-recap', paren: 'Youtube', url: 'https://www.youtube.com/results?search_query=Kingdom%20Hearts%20Chain%20of%20Memories%20story%20recap' },
            { key: 'fan-playthrough', paren: 'Youtube', url: 'https://www.youtube.com/results?search_query=Kingdom%20Hearts%20Chain%20of%20Memories%20playthrough' },
          ],
        ],
        extras: [
          {
        ...
        { title: 'Kingdom Hearts: Chain of Memories ~Manga~ (2005)', releaseDate: '2005-10-22', chronoOrder: 150, recommendedOrder: 250, tags: ['Optional', 'Manga'], mediaType: 'Comic', helpWanted: true, lengthParts: [{ value: '2? volumes' }],
        parts: [
        ...
        languages: [
          ...
          { value: 'EN', tip: 'English', url: 'https://www.goodreads.com/book/show/24396851-kingdom-hearts' },
          { value: 'FR', tip: 'French', url: 'https://www.goodreads.com/book/show/35672167-kingdom-hearts-l-int-grale-t02' },
          { value: 'PT', tip: 'Portuguese', url: 'https://www.goodreads.com/book/show/55779535-kingdom-hearts' },
          { value: 'DE', tip: 'German', url: 'https://www.goodreads.com/book/show/10874334-kingdom-hearts' },
          { value: 'ES', tip: 'Spanish (Castilian)', url: 'https://www.goodreads.com/book/show/25544261-kingdom-hearts-chain-of-memories-vol-1' },
          { value: 'IT', tip: 'Italian', url: 'https://www.goodreads.com/book/show/34033481-kingdom-hearts' },
          { value: 'FI', tip: 'Finnish', url: 'https://www.goodreads.com/book/show/61093550-kingdom-hearts-chain-of-memories-1' },
        ...
        languages: [
          ...
          { value: 'JA', tip: 'Japanese', native: true, url: 'https://www.goodreads.com/book/show/77683042' },
          { value: '…?', tip: 'Unknown additional languages' },
        ],
        platformGroups: [
          [{ key: 'book', name: 'Novel', noUrl: true }],
        ...
        platformGroups: [
          ...
          [
            { key: 'fan-movie', paren: 'Youtube', url: 'https://www.youtube.com/results?search_query=Kingdom%20Hearts%20II%20game%20movie' },
            { key: 'fan-recap', paren: 'Youtube', url: 'https://www.youtube.com/results?search_query=Kingdom%20Hearts%20II%20story%20recap' },
            { key: 'fan-playthrough', paren: 'Youtube', url: 'https://www.youtube.com/results?search_query=Kingdom%20Hearts%20II%20playthrough' },
          ],
        ],
        },
      ]};
