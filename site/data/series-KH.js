...
window.__khSeriesReg['KH'] = { num: 'KH', releaseDate: '2002-03-28', chronoOrder: 1075, recommendedOrder: 1795, title: 'Kingdom Hearts', note: 'A franchise in its own right, with original characters and story. A crossover that primarily focuses on Disney characters, though some entries also feature Final Fantasy characters.', games: [
        ...
        title: 'Kingdom Hearts', title_url: 'https://wikipedia.org/wiki/Kingdom_Hearts_(video_game)', title_date: '2002-03-28',
        ...
        { chronoOrder: 25, recommendedOrder: 125, tags: ['Optional', 'Manga'], mediaType: 'Comic', lengthParts: [{ value: '4 volumes' }],
        title: 'Kingdom Hearts ~Manga~', title_url: 'https://wikipedia.org/wiki/List_of_Kingdom_Hearts_media#Kingdom_Hearts', title_date: '2003-10-25',
        subtitle: 'Comic',
        description: [
          [
        ...
        { chronoOrder: 50, recommendedOrder: 150, tags: ['Optional', 'YA Novel'], mediaType: 'Book', helpWanted: true, lengthParts: [{ value: '2 volumes' }],
        title: 'Kingdom Hearts: The Novel', title_url: 'https://wikipedia.org/wiki/List_of_Kingdom_Hearts_media#Kingdom_Hearts_2', title_date: '2005-06-30',
        subtitle: 'Book',
        description: [
          [
        ...
        { chronoOrder: 100, recommendedOrder: 200, mediaType: 'Game', tags: ['Sequel', 'Action RPG', 'Card-based Battles', 'Single-player', 'Multiplayer'], lengthParts: [{ value: '23h', tip: 'Main Story', sep: true, sepChar: ' / ' }, { value: '31½h', tip: 'Main + Sides', sep: true, sepChar: ' / ' }, { value: '60½h', tip: 'Completionist' }],
        title: 'Kingdom Hearts: Chain of Memories', title_url: 'https://wikipedia.org/wiki/Kingdom_Hearts:_Chain_of_Memories', title_date: '2004-11-11',
        ...
        { chronoOrder: 150, recommendedOrder: 250, tags: ['Optional', 'Manga'], mediaType: 'Comic', helpWanted: true, lengthParts: [{ value: '2? volumes' }],
        title: 'Kingdom Hearts: Chain of Memories ~Manga~', title_url: 'https://wikipedia.org/wiki/List_of_Kingdom_Hearts_media#Kingdom_Hearts:_Chain_of_Memories', title_date: '2005-10-22',
        subtitle: 'Comic',
        ...
        { chronoOrder: 175, recommendedOrder: 275, tags: ['Optional', 'YA Novel'], mediaType: 'Book', helpWanted: true, lengthParts: [{ value: '3 volumes' }],
        title: 'Kingdom Hearts: Chain of Memories The Novel', title_url: 'https://wikipedia.org/wiki/List_of_Kingdom_Hearts_media#Kingdom_Hearts:_Chain_of_Memories_2', title_date: '2005-10-22',
        subtitle: 'Book',
        description: [
          [
            { text: 'YA Novelization of ' },
        ...
        { mainline: true, chronoOrder: 200, recommendedOrder: 300, mediaType: 'Game', tags: ['Sequel', 'Action RPG', 'Hack and slash', 'Single-player'],
        title: 'Kingdom Hearts II', title_url: 'https://wikipedia.org/wiki/Kingdom_Hearts_II', title_date: '2005-12-22',
